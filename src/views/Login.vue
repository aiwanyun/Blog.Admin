    ...
    <div class="wrapper">
        ...
        <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px"
            ...
            <el-form-item prop="account">
                <el-input type="text" v-model="ruleForm2.account" @keyup.enter.native.prevent="handleSubmit2"
                    auto-complete="off" placeholder="账号"></el-input>
            </el-form-item>
            <el-form-item prop="checkPass">
                <el-input v-model="ruleForm2.checkPass" @keyup.enter.native.prevent="handleSubmit2" auto-complete="off"
        ...
        GetNavigationBar(uid) {
            ...
            getNavigationBar(loginParams).then(data => {
                ...
                if (!data.success) {
                    ...
                    _this.$router.replace(redirect ? redirect : "/");
                }
            });
        }
    },
